...
include_once $this->targetDirs[3].'/src/DataFixtures/EmployerFixtures.php';
include_once $this->targetDirs[3].'/src/DataFixtures/ServiceFixtures.php';

$a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\EmployerFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ServiceFixtures(), 'groups' => []]]);
