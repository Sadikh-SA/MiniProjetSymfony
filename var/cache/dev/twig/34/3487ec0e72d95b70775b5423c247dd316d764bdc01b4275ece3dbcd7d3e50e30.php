...
class __TwigTemplate_d1978aafd667f0ca0fbc1ebd67469aff9d55d2b00091de299df61b189f4d3c6b extends \Twig\Template
{
    ...
    ";
        // line 6
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["formEmployer"]) || array_key_exists("formEmployer", $context) ? $context["formEmployer"] : (function () { throw new RuntimeError('Variable "formEmployer" does not exist.', 6, $this->source); })()), 'form_start', ["attr" => ["novalidate" => "novalidate"]]);
        echo "
...
{% block body %}
    ...
    {{ form_start(formEmployer , {'attr': {'novalidate': 'novalidate'} }) }}
