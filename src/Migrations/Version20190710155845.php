 ...
 */
final class Version20190710155845 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE employer (id INT AUTO_INCREMENT NOT NULL, id_service_id INT DEFAULT NULL, matricule VARCHAR(255) NOT NULL, nomcomplet VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, salaire INT NOT NULL, INDEX IDX_DE4CF06648D62931 (id_service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
